// FolderSize5.cpp : Defines the entry point for the application.
//
#pragma once
...
#define MAX_LOADSTRING 100
    ...
    LRESULT CALLBACK    WndProcChild1(HWND, UINT, WPARAM, LPARAM);
        ...
        _In_ int       nCmdShow)
    {
        ...
        HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_FOLDERSIZE5));
